...
public class MarshallingCodeCFactory {
    ...
    public static MarshallingDecoder buildMarshallingDecoder() {
        /*
         * 通过 Marshalling 工具类的 getProvidedMarshallerFactory 静态方法获取MarshallerFactory 实例, , 参数 serial 表示创建的是 Java 序列化工厂对象.它是由 jboss-marshalling-serial
         * 包提供
         */
    ...
    public static MarshallerProvider buildProvider() {
        ...
        return new DefaultMarshallerProvider(marshallerFactory, configure);
    }
